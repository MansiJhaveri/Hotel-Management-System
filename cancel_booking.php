...
function validateForm() {
    var name1 = document.cancel_booking.name.value;
    var contact_no1 = document.cancel_booking.contact_no.value;    
    var email1 = document.cancel_booking.email.value;
...
<form name="cancel_booking" onsubmit="return validateForm()">
